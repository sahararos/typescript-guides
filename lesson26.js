...
*/
var i = 0; // This is our initialiser.
...
var arrayOfColors = ['red', 'blue', 'green', 'yellow', 'purple'];
var color = 0;
while (color < arrayOfColors.length) {
    console.log("".concat(arrayOfColors[color]));
    color++;
}
...
do { // This code means "do this" (see code in curly braces) while the condition is true.
    console.log("The number is ".concat(i)); // The code to be run first.
    i++;
