...
var supers = ['Superman', 'Batman', 'Flash', 'Aquaman']; //We create an empty array using square brackets. The brackets will hold all of our array values. 
...
var heroes = []; // This creates an empty array called heroes. The : string[] part is a type annotation that specifies that this array will only hold string values.
/* As mentioned before, arrays can also include other data types.  */
var randomStuff = [42, 'apple', true, { name: 'John' }, [1, 2, 3]]; // This array contains a number, a string, a boolean, an object, and another array. To create an array we simply use square brackets [] and separate each value with a comma. 
...
var countries = ['Iceland', 'Spain', 'Sweden'];
countries[3] = 'Ukraine';
