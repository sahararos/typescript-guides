...
// > more than
console.log(x > 10 //What this is saying is, is 7 more than the number 10?
, //What this is saying is, is 7 more than the number 10?
x > 6); // Output: false (because 7 is not more than 10), true (because 7 is more than 6).
...
// < less than
console.log(x < 10 //What this is saying is, is 7 less than the number 10?
, //What this is saying is, is 7 less than the number 10?
x < 6); // Output: true (because 7 is less than 10), false (because 7 not less than 6).
...
// === strict equality
var y = "7";
console.log(x === 7 // Output: true because x is equal to number 7 in terms of its value and data type.
, // Output: true because x is equal to number 7 in terms of its value and data type.
