...
var dateString = new Date("August 29 2019 08:34:00");
...
var componentDate = new Date(1999, 11, 25, 14, 0, 0, 0);
...
dateString.getFullYear(), componentDate.getFullYear()); // The output is: 2025 2025 2019 1999
// getMonth
...
var milliseconds = new Date(1758720204918); // Put the output in the line above here.
...
console.log("".concat(hour, ":").concat(min)); //Output: 13:47 (current time).
/* 4. Console log the name of the current day, you can use the long or shorthand. */
var day = todaysDate.toLocaleString('default', { weekday: 'long' });
