...
function favGame(game) {
    console.log("My favorite game is ".concat(game));
}
...
function ninjaTurtles(name, weapon) {
    console.log("".concat(name, " uses the ").concat(weapon));
}
...
function favMovie(movie) {
    if (movie === void 0) { movie = "No movie provided"; }
...
function favBook(book) {
    if (book === undefined) {
        ...
        console.log("My favorite book is ".concat(book));
    }
}
...
function favFood(response) {
    if (response === undefined) {
        ...
        console.log("Your favorite food is ".concat(response));
    }
}
favFood("pasta");
