...
let message = age >= 18 ? "You can vote" : "Sorry, you cannot vote.";
console.log(message);
...
let info = (password === "redruby123") ? "Success" : "Fail"; // You can use parentheses to make the code easier to read. 
console.log(info);
...
let newMessage = (1 > 10) ? "Condition is TRUE" : "Condition is FALSE";
