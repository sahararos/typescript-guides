...
function games() {
    let title = "Zelda"; // This variable here is known as a "local" variable. In other words, it's local to this particular function.
...
let greeting = "Hey there!"; // This is a global variable.
console.log(greeting);

/* Functions can also be anonymous, that is, without a name.  */

let btn = document.querySelector("#btn") // Here we're working with the document object model (DOM), but we'll look deeper into it in another lesson.
