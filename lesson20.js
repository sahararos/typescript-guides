...
var game; //undefined
var game2 = null; // null
var game3 = "Sonic"; // String
console.log(game !== null && game !== void 0 ? game : game3);
...
For example:*/
var user;
console.log(user !== null && user !== void 0 ? user : "Guest");
...
for example:
*/
var score = 0; // This is a falsy value. 
...
console.log(score !== null && score !== void 0 ? score : "no score registered"); // Now we get the score "0" logged to the console.
...
var course;
console.log(course !== null && course !== void 0 ? course : "Please select a course");
/* 2. What will the following return? */
var courseProgress = 0;
console.log(courseProgress !== null && courseProgress !== void 0 ? courseProgress : "Start the course");
// This will return "0".
