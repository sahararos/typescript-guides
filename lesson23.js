...
switch (roll) {
    ...
    default: // If none of the other cases match, execute the following code:
        console.log("The number ".concat(roll, " is not possible."));
}
...
4. */
var today = new Date().toLocaleString('default', { weekday: 'short' });
switch (true) {
    case today === "Mon":
...
switch (true) {
    case favFood === "chicken":
        console.log("That's right! ".concat(favFood, " is my favorite!"));
        break;
    case favFood === "fish":
        console.log("That's right! ".concat(favFood, " is my favorite!"));
        break;
